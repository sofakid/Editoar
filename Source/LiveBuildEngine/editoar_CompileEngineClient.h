...
#ifndef __EDITOAR_CLANGCLIENT_H_5AE7396F__
#define __EDITOAR_CLANGCLIENT_H_5AE7396F__

#include "editoar_ActivityList.h"
#include "editoar_ErrorList.h"
class Project;
...
struct ChildProcessCache
{
    ...
    {
        OpenDocumentManager& odm = EditoarApplication::getApp().openDocumentManager;
...
#endif  // __EDITOAR_CLANGCLIENT_H_5AE7396F__
