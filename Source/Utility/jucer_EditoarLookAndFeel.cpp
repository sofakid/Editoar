...
#include "jucer_EditoarLookAndFeel.h"


EditoarLookAndFeel::EditoarLookAndFeel()
{
    setColour (mainBackgroundColourId, Colour::greyLevel (0.8f));
}

int EditoarLookAndFeel::getTabButtonBestWidth (TabBarButton&, int)
{
    return 120;
}

Colour EditoarLookAndFeel::getTabBackgroundColour (TabBarButton& button)
{
...
void EditoarLookAndFeel::drawConcertinaPanelHeader (Graphics& g, const Rectangle<int>& area,
...
void EditoarLookAndFeel::fillWithBackgroundTexture (Graphics& g)
{
...
void EditoarLookAndFeel::fillWithBackgroundTexture (Component& c, Graphics& g)
{
    dynamic_cast<EditoarLookAndFeel&> (c.getLookAndFeel()).fillWithBackgroundTexture (g);
}
