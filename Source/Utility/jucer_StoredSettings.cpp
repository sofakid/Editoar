...
{
    return *EditoarApplication::getApp().settings;
}
...
void StoredSettings::updateKeyMappings()
{
    ...
    if (ApplicationCommandManager* commandManager = EditoarApplication::getApp().commandManager)
    {
